...
<TypeTable type={{
  ...
  maxTokens: { type: "number", default: "16384", description: "Tokens the model may generate per request, including any hidden reasoning tokens." },
  concurrency: { type: "number", default: "4", description: "Requests in flight at once." },
  contextChars: { type: "number", default: "24000", description: "Document text per request. Also the cache granule." },
  perRule: { type: "boolean", default: "true", description: "Send one request per rule instead of one per section carrying every rubric." },
}} />
