...
export const builtInRules: Rule[] = [
  ...
  phraseRule(
    ...
    [
      ...
      rx(/\bpowerful\b/gi, "Avoid the filler adjective “powerful”.", "State the specific capability."),
      rx(/\bseamless(?:ly)?\b/gi, "Avoid the hype word “seamless”.", "Describe what actually happens."),
      ...
      rx(/\bnavigate the landscape of\b/gi, "Avoid “navigate the landscape of”.", "Describe the task."),
      rx(/\bit['’]s worth noting that\b/gi, "State the point directly.", "Drop the throat-clearing."),
