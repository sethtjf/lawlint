...
rationale: "Human legal prose is bursty — long reasoning sentences sit next to short holdings and citations. Machine prose keeps sentence length uniform, and uniformity is much harder to prompt away than any word list."
message: "Sentence lengths are uniform across the document; vary the rhythm."
